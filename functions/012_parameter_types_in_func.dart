...
// @required annotation is depends on meta package 
...
void main(){
  print(addition(12, 8)); // calling the required parameter function by passing all the parameters

  print(subtraction(param1: 15, param2: 5)); // calling named parameters function
  print(subtraction(param2: 20, param1: 14)); // no need of maintaining order in named function
  ...
  print(multiplication()); // when arguments are not provided, it will take default values
  print(multiplication(param1: 25, param2: 25)); // overrides the default value

  print(message("Rick", "Morty"));
  print(message("Rick", "Morty","Good Night!!!")); // overrides the default value
